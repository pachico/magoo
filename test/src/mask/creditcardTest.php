...
class CreditcardTest extends \PHPUnit_Framework_TestCase
{
	 ...
	 */
	protected $_strings_with_valid_credit_cards = [
	 ...
	 */
	protected $_strings_without_valid_credit_card = [
	...
	public function test__constructor()
	{
		...
		foreach ($this->_strings_with_valid_credit_cards as $input => $output)
		{
	...
	public function testMask()
	{
		...
		foreach ($this->_strings_without_valid_credit_card as $input)
		{
